(function($) {
    ...
    $('.cart-quantity').append('<span class="dec qtybtn cart-qty-btn"><i class="fa fa-angle-left"></i></span><span class="inc qtybtn cart-qty-btn"><i class="fa fa-angle-right"></i></span>');
    ...
    $('.cart-qty-btn').on('click', function() {
        var $button = $(this);
        var slug = $button.parent().find('input.item-slug').val();
        var quantity = parseInt($button.parent().find('input.qty').val());
