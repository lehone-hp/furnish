                                    ...
                                    <div class="col-xs-12 mb-30">
                                        ...
                                        <select id="b_country" name="country">
                                            @foreach(\App\Country::all() as $country)
                                                <option value="{{ $country->name }}" @if( old('country', $user->country) == $country->name) selected @endif>
                                                    {{ $country->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            @guest
                                <div class="row">
                                    <div class="col-xs-12 mb-30">
                                        ...
                                        <select id="b_country" name="country">
                                            @foreach(\App\Country::all() as $country)
                                                <option value="{{ $country->name }}" @if( old('country') == $country->name) selected @endif>
                                                    {{ $country->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-xs-12 mb-30">
                                        ...
                                        <div class="collapse mt-20" data-collapse="createp_account">
                                            ...
                                            <label for="b_a_password" class="mt-20">Confirm password  <span class="required">*</span></label>
                                            <input id="b_a_password" type="password" placeholder="Password"
                            ...
                            <div class="collapse row" data-collapse="shipping_form">
                                <div class="col-xs-12 mb-30">
                                    ...
                                    <select id="s_country" name="ship_country">
                                        @foreach(\App\Country::all() as $country)
                                            <option value="{{ $country->name }}" @if( old('ship_country') == $country->name) selected @endif>
                                                {{ $country->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
