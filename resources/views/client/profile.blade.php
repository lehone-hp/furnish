    ...
    <div class="row">
                    ...
                    <div class="author">
                        ...
                        <div class="container">
                            <ul class="list-unstyled">
                                <li><p><i class="fa fa-map-marker m-r-xs"></i> {{ $user->city }}, {{ $user->country }}</p></li>
                                <li><p><i class="fa fa-phone m-r-xs"></i> {{ $user->phone }}</p></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-8 col-md-7">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('client.profile') }}" method="post" novalidate="novalidate">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Country</label>
                                    <select name="country" class="form-control border-input" id="r_country">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control border-input" placeholder="ZIP Code"
                                           name="zip"
